            ...
            >
              ...
              >
                ...
                <MuiButton
                  variant="contained"
                  content="Book"
                  onClick={() => navigate(`/bookings/create/${data.name}`)}
                />
                {userData.role === "admin" && (
                  <>
                    <MuiButton
                      variant="contained"
                      content="Edit"
                      onClick={() => navigate(`/rooms/edit/${data.name}`)}
                    />
                  </>
                )}
              </Box>
        ...
        <Box sx={modalStyle}>
          ...
          >
            <Grid item>
              ...
              />
              <Box>
                <Typography>Location: {modalData.location}</Typography>
                ...
                {modalData.equipment && (
                  <Box>
                    ...
                    <Box>
                      {modalData.equipment.map((item, index) => (
                        <Typography
                          key={index}
                          sx={{
                            pl: 2,
            ...
            <Grid item>
              {modalData.bookings && modalData.bookings.length > 0 ? (
                <Box>
              ...
              >
                <MuiButton
                  variant="contained"
                  content="Book"
                  onClick={() => navigate(`/bookings/create/${modalData.name}`)}
                />
                {userData.role === "admin" && (
                  <MuiButton
                    variant="contained"
