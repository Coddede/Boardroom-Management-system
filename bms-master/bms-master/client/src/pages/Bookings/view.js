        ...
        <Box sx={modalStyle}>
          ...
          >
            ...
            >
              ...
              <Typography>Start Time: {modalData.StartTime}</Typography>
              <Typography>End Time: {modalData.EndTime}</Typography>
              <Typography>Status: {modalData.Status}</Typography>
              <Typography>Zoom Link: {modalData.zoomLink}</Typography>
              {
                <Box>
                  <Typography>Participants:</Typography>
                  <Box>
                    {modalData.participants?.map((item, index) => (
                      <Typography
                        key={index}
                        sx={{
                          pl: 2,
            ...
            >
              ...
              <UpdateBookingForm
                initialFormValues={{
                  ...
                  participants: modalData.participants?.join(","),
